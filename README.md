...
### Bugs
  ...
  - __Incorrect Answer Colour Not Clearing__ - If an incorrect answer was selected, the colour stayed red after the "Next Question" button was clicked. This was fixed by moving the "selectedAnswer.classList.remove("incorrect_answer/correct_answer")" outside the "goToNextQuestion" function in the quiz.js file;
...
- [JamesQQuick](https://github.com/jamesqquick/Build-A-Quiz-App-With-HTML-CSS-and-JavaScript/tree/master/11.%20Fetch%20API%20Questions%20from%20Open%20Trivia%20API) - Used code from his Quiz App in building quiz javscript (referenced in quiz.js) and to style progress bar.
